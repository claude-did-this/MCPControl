...
const CLICK_INTERVAL = 1000; // Click every second
...
function startServer() {
    ...
    const server = app.listen(SERVER_PORT, () => {
        console.log(`Test panel server running at http://localhost:${SERVER_PORT}/test-panel.html`);
    });
...
async function runAccuracyTest() {
    ...
    await open(`http://localhost:${SERVER_PORT}/test-panel.html`);
